...
padding: 50px 50px;
  ...
  <head>
	...
	<script type="text/javascript" src="/1A26EE39-93AB-A145-9AAA-AAD8D3CF1CBB/main.js" charset="UTF-8"></script><style>
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <!-- Menu Footer-->
                    ...
                    <!--a id="delUserText" onclick="Del_Acc_Confirmation();"> مسح الحساب</a-->
...
<div class="content-wrapper"> <!--===DONT REMOVE THE 'CONTENT WRAPPER' DIV...PUT THE CONTENT INSIDE IT===-->
	<div id="fall">
		<button id="faf" class="btn"><img id="imgd" src="../Public/Icons/Charity.jpg" /> التبرعات</button>
		<button id="faf" class="btn"><img id="imgd" src="../Public/Icons/Contributor.jpg" /> المتبرعين</button>
		<button id="faf" class="btn"><img id="imgd" src="../Public/Icons/Resident.jpg" /> المستفيدتن</button>
		<button id="faf" class="btn"><img id="imgd" src="../Public/Icons/Inventory.jpg" /> المخزن</button>
		<button id="faf" class="btn"><img id="imgd" src="../Public/Icons/Employee.jpg" /> الموظفين</button>
		<button id="faf" class="btn"><img id="imgd" src="../Public/Icons/Inventory_Outcome.jpg" /> مصروفات</button>
		<button id="faf" class="btn"><img id="imgd" src="../Public/Icons/Report.jpg" /> التقارير</button>
		<button id="faf" class="btn"><img id="imgd" src="../Public/Icons/Mail.jpg" /> البريد</button>
		<button id="faf" class="btn"><img id="imgd" src="../Public/Icons/Notification.jpg" /> التنبيهات</button>
	</div>
</div>
