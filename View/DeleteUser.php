...
{
	public function display_del_error_msg($msg)
	{
		echo "<script>
		display_del_error_msg('$msg');
		</script>";
	}
}
?>
<script>
function display_del_error_msg(msg)
{
	var error_label=document.getElementById("del_check_msg");
...
<div class="content-wrapper">
	<div style="margin-top:200px; margin-right:400px;">
		<form action="../Controller/UserController.php" method="get">
			<span style="font-weight:bold; font-size:25pt;">أكد كلمة السر</span>
			<input type="password" name="Password" style="height:40px; width:200px;">
			<label id="del_check_msg" style="float:center; color:red;"></label><br><br><br>
			<button name="DeleteUser"
			style="height:40px;width:200px;font-size:14pt; background-color: red; margin-right:50px;"><b>نعم اريد مسح الحساب</b></button>
		</form>
	</div>
</div>
<!--===================================================================SIDEBAR=================================================== -->
